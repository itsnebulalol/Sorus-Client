...
public class DefaultCustomTextColor extends DefaultThemeBase<CustomTextColor>
  ...
  public DefaultCustomTextColor(
      DefaultTheme theme,
      Collection main,
      Setting<List<List<Pair<String, Color>>>> setting,
      String description) {
    super(theme);
    this.main = main;
  ...
  public class NewButton extends Collection {
    ...
    public NewButton() {
      this.add(new Rectangle().size(7.5, 40).position(21.25, 5));
      this.add(new Rectangle().size(40, 7.5).position(5, 21.25));
      this.attach(
          new Recolor(
              100,
              50,
      ...
      if (this.getContainer().isTopLevel()) {
        if (e.getX() > this.absoluteX()
          ...
          CustomTextLine customTextLine =
              new CustomTextLine()
                  .position(10, 10 + DefaultCustomTextColor.this.customTextLines.size() * 100);
  ...
  public class CustomTextLine extends Collection {
    ...
    public class CustomText extends Collection {
      ...
      public CustomText(String string, Color color) {
        this.add(
            rectangle =
                new Rectangle().smooth(5).color(defaultTheme.getElementBackgroundColorNew()));
        ...
        public void onClick(MousePressEvent e) {
          if (this.getContainer().isTopLevel()) {
            if (e.getX() > this.absoluteX()
              ...
              Sorus.getSorus()
                  .getGUIManager()
                  .open(new ColorPickerScreen(CustomText.this.color, new ColorCallback()));
            }
          }
        }
