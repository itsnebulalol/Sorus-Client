...
public class DefaultToggle extends DefaultThemeBase<Toggle> implements IConfigurableTheme {
  ...
  public DefaultToggle(
      DefaultTheme theme, Collection main, Setting<Boolean> setting, String description) {
    super(theme);
    this.main = main;
