...
public class DefaultTextBox extends ConfigurableThemeBase<TextBox> {

    private final Collection main;

    private final Setting<String> setting;

    public DefaultTextBox(Collection main, Setting<String> setting, String description) {
        this.main = main;
    ...
    public class TextBoxInner extends Collection {
        ...
        public TextBoxInner() {
            this.add(rectangle = new Rectangle().smooth(5).size(250, 50).color(DefaultTheme.getElementBackgroundColorNew()));
