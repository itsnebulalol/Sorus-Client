...
public class KeystrokesComponent extends Component {
  ...
  public enum Mode {
    WASD(
        new KeystrokesKey.Bind(KeybindType.FORWARD, 21, 0, 18, 18),
        new KeystrokesKey.Bind(KeybindType.LEFT, 0, 20, 18, 18),
        new KeystrokesKey.Bind(KeybindType.BACK, 21, 20, 18, 18),
        new KeystrokesKey.Bind(KeybindType.RIGHT, 42, 20, 18, 18)),
    WASD_SPACE(
