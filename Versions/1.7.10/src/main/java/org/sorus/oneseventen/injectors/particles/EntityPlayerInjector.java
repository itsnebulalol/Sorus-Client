...
public class EntityPlayerInjector extends Injector<EntityPlayer> {
    ...
    public static void modifyAttackTargetEntityWithCurrentItem(MethodNode methodNode) {
        ...
        String onCriticalHitDesc = ObfuscationManager.getDesc("(Lnet/minecraft/entity/Entity;)V");
        ...
        String onEnchantmentCriticalDesc = ObfuscationManager.getDesc("(Lnet/minecraft/entity/Entity;)V");
        ...
        for(AbstractInsnNode node : methodNode.instructions.toArray()) {
            ...
            if(node instanceof MethodInsnNode && ((MethodInsnNode) node).name.equals(onCriticalHitMethod) && ((MethodInsnNode) node).desc.equals(onCriticalHitDesc)) {
            ...
            if(node instanceof MethodInsnNode && ((MethodInsnNode) node).name.equals(onEnchantmentCriticalMethod) && ((MethodInsnNode) node).desc.equals(onEnchantmentCriticalDesc)) {
