...
public class Screen implements IScreen {
    ...
    public double getScaledWidth() {
        ...
        return new ScaledResolution(mc, mc.displayWidth, mc.displayHeight).getScaledWidth_double();
    }

    @Override
    public double getScaledHeight() {
        Minecraft mc = Minecraft.getMinecraft();
        return new ScaledResolution(mc, mc.displayWidth, mc.displayHeight).getScaledHeight_double();
    }
    @Override
