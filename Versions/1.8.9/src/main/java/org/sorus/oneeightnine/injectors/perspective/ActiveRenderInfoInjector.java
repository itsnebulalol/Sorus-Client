...
@Hook("net/minecraft/client/renderer/ActiveRenderInfo")
public class ActiveRenderInfoInjector extends Injector<ActiveRenderInfo> {

    public ActiveRenderInfoInjector(ActiveRenderInfo that) {
        super(that);
    }

    @Modify(name = "updateRenderInfo", desc = "(Lnet/minecraft/entity/player/EntityPlayer;Z)V")
    public static void modifyUpdateRenderInfo(MethodNode methodNode) {
